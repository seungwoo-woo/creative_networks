...
function CalcPhone(props) {

// Initialize Variable ==================================================
const {no, telCom, openCom, type, openDate, openType, phoneModel, phoneSerial, phoneColor, customerName, nationality, phoneNo, birthday, callingPlan, controlNo, memo, sellCom, rebate, myRebate, netRebate, getDataRefresh, userGrade} = props;
